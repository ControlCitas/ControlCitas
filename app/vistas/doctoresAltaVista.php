...
<div class="card p-4 bg-light">
  <form enctype="multipart/form-data" action="<?php print RUTA; ?>doctores/alta/" method="POST">
    ...
    <div class="form-group text-left">
      ...
      <?php
      if (isset($datos["baja"])) { ?>
        <a href="<?php print RUTA; ?>doctores/bajaLogica/<?php print $datos['data']['id']; ?>" class="btn btn-danger">Borrar</a>
        <a href="<?php print RUTA; ?>doctores" class="btn btn-danger">Regresar</a>
